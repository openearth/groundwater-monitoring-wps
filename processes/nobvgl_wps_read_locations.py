...
# http://localhost:5000/wps?service=wps&request=Execute&version=2.0.0&Identifier=nobvgl_wps_read_locations&datainputs=projectinfo={"projectnr":11206020}
...
class NOBVGLReadlocations(Process):
    def __init__(self):
        inputs = [ComplexInput('projectinfo', 'List of projectnumbers',
